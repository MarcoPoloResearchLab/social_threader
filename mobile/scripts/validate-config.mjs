...
assertEqual(packageJson.dependencies?.expo, "57.0.25", "mobile package must use the Expo SDK 57 runtime");
...
assertEqual(packageJson.dependencies?.["expo-image-picker"], "57.0.20", "mobile package must use Expo SDK image picker for native image attachments");
