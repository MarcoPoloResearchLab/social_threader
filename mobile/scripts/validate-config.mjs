...
assertEqual(packageJson.dependencies?.expo, "57.0.23", "mobile package must use the Expo SDK 57 runtime");
...
assertEqual(packageJson.dependencies?.["expo-image-picker"], "57.0.18", "mobile package must use Expo SDK image picker for native image attachments");
