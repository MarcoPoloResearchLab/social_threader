...
assertEqual(packageJson.dependencies?.expo, "57.0.22", "mobile package must use the Expo SDK 57 runtime");
...
assertEqual(packageJson.dependencies?.["expo-clipboard"], "57.0.2", "mobile package must use Expo SDK clipboard for native image copies");
assertEqual(packageJson.dependencies?.["expo-image-picker"], "57.0.17", "mobile package must use Expo SDK image picker for native image attachments");
